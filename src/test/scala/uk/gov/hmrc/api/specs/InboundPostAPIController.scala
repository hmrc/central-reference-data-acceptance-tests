...
import uk.gov.hmrc.api.utils.InboundSoapMessage.{xmlFullMessage, xmlFullMessageErrorReport, xmlFullMessageIsAlive, xmlFullMessageIsAliveWithInvalidMessage, xmlSubscriptionDeltaRequest, xmlSubscriptionErrorReportMessage}
